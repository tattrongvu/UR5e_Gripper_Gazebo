...
(cl:defclass <RobotiqGripperCommand> (roslisp-msg-protocol:ros-message)
  ((emergency_release
...
(cl:defclass RobotiqGripperCommand (<RobotiqGripperCommand>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RobotiqGripperCommand>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RobotiqGripperCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotiq_2f_gripper_msgs-msg:<RobotiqGripperCommand> is deprecated: use robotiq_2f_gripper_msgs-msg:RobotiqGripperCommand instead.")))

(cl:ensure-generic-function 'emergency_release-val :lambda-list '(m))
(cl:defmethod emergency_release-val ((m <RobotiqGripperCommand>))
...
(cl:defmethod emergency_release_dir-val ((m <RobotiqGripperCommand>))
...
(cl:defmethod stop-val ((m <RobotiqGripperCommand>))
...
(cl:defmethod position-val ((m <RobotiqGripperCommand>))
...
(cl:defmethod speed-val ((m <RobotiqGripperCommand>))
...
(cl:defmethod force-val ((m <RobotiqGripperCommand>))
  ...
  (force m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotiqGripperCommand>) ostream)
  "Serializes a message object of type '<RobotiqGripperCommand>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotiqGripperCommand>) istream)
  "Deserializes a message object of type '<RobotiqGripperCommand>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotiqGripperCommand>)))
  "Returns string type for a message object of type '<RobotiqGripperCommand>"
  "robotiq_2f_gripper_msgs/RobotiqGripperCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotiqGripperCommand)))
  "Returns string type for a message object of type 'RobotiqGripperCommand"
  "robotiq_2f_gripper_msgs/RobotiqGripperCommand")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotiqGripperCommand>)))
  "Returns md5sum for a message object of type '<RobotiqGripperCommand>"
  "017fc0d464f4a4d072ae2519e0fc1789")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotiqGripperCommand)))
  "Returns md5sum for a message object of type 'RobotiqGripperCommand"
  "017fc0d464f4a4d072ae2519e0fc1789")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotiqGripperCommand>)))
  "Returns full string definition for message of type '<RobotiqGripperCommand>"
  (cl:format cl:nil "bool emergency_release~%uint32 emergency_release_dir~%bool stop~%float32 position #[m] Distance in bewteen fingers ~%float32 speed    #[m/s] Speed (Min: 0.013m/s - Max: 0.1m/s)~%float32 force    #[%] Percentage of gripper force to apply (Min: 0.0% - Max: 100.0%)~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotiqGripperCommand)))
  "Returns full string definition for message of type 'RobotiqGripperCommand"
  (cl:format cl:nil "bool emergency_release~%uint32 emergency_release_dir~%bool stop~%float32 position #[m] Distance in bewteen fingers ~%float32 speed    #[m/s] Speed (Min: 0.013m/s - Max: 0.1m/s)~%float32 force    #[%] Percentage of gripper force to apply (Min: 0.0% - Max: 100.0%)~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotiqGripperCommand>))
  (cl:+ 0
     1
     4
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RobotiqGripperCommand>))
  "Converts a ROS message object to a list"
  (cl:list 'RobotiqGripperCommand
