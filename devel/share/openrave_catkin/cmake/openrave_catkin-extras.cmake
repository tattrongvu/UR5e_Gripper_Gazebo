...
set(OpenRAVE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/${CATKIN_GLOBAL_SHARE_DESTINATION}/openrave-${OpenRAVE_LIBRARY_SUFFIX}")
...
function (openrave_plugin target_name)
    ...
    # versions.
        ...
        target_include_directories("${target_name}" SYSTEM PRIVATE "${OpenRAVE_INCLUDE_DIRS}")
    endif ()
