...
class CommandRobotiqGripperGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommandRobotiqGripperGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandRobotiqGripperGoal(null);
...
module.exports = CommandRobotiqGripperGoal;
