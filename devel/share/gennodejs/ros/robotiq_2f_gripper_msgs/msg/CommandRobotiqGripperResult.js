...
class CommandRobotiqGripperResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommandRobotiqGripperResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandRobotiqGripperResult(null);
...
module.exports = CommandRobotiqGripperResult;
