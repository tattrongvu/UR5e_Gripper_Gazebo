...
class CommandRobotiqGripperFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommandRobotiqGripperFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandRobotiqGripperFeedback(null);
...
module.exports = CommandRobotiqGripperFeedback;
